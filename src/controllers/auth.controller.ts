...
export const resendActivation = async (req: Request, res: Response) => {
  try {
    ...
    logger.error("resendActivation error: " + (err.message || err));
    return res.status(500).json({ message: "Server error" });
  }
};
...
export const activate = async (req: Request, res: Response) => {
  try {
    ...
    logger.error("activate error: " + (err.message || err));
    return res.status(500).json({ message: "Server error" });
  }
};
...
export const forgotPassword = async (req: Request, res: Response) => {
  try {
    ...
    logger.error("forgotPassword error: " + (err.message || err));
    return res.status(500).json({ message: "Server error" });
  }
};
...
export const resetPassword = async (req: Request, res: Response) => {
  try {
    ...
    logger.error("resetPassword error: " + (err.message || err));
    return res.status(500).json({ message: "Server error" });
  }
};
