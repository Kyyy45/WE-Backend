export const activationTemplate = (fullName: string, activationLink: string) => `
    ...
    <table width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 14px rgba(0,0,0,0.08);">
      ...
      <tr>
        <td style="padding: 36px 40px;">
          <h2 style="color: #111827; font-size: 20px; margin-bottom: 18px;">Halo, ${fullName}</h2>
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 28px;">
            Terima kasih telah bergabung bersama <strong>Worldpedia Education</strong>.<br/>
            Silakan aktifkan akun Anda dengan mengklik tombol di bawah ini:
          </p>
          ...
          <p style="color: #6b7280; font-size: 14px; line-height: 1.6;">
            Link ini hanya berlaku selama <strong>24 jam</strong>.<br/>
